...
1. Editor creates new post: "New Bike Sharing Program"
2. Clicks "Generate with AI"
3. AI produces draft based on title
4. Editor reviews, edits, and publishes
...
- ✅ Add city-specific details manually
- ✅ Verify dates, numbers, and facts
...
- ✅ Creating layer descriptions quickly
- ✅ Maintaining consistent documentation
- ✅ Explaining technical data to citizens
...
- Layer: "Air Quality Monitoring"
- Entity Type: `AirQualityObserved`
- Attributes: `pm25`, `pm10`, `no2`, `co`
...
- ✅ Include technical context (entity type, attributes)
...
- ✅ Recommending color schemes for layers
- ✅ Suggesting zoom levels for map views
- ✅ Proposing filter configurations
- ✅ Auto-generating legend labels
...
- AI suggests: `['#00E400', '#FFFF00', '#FF7E00', '#FF0000', '#8F3F97']`
- Rationale: Standard AQI color scheme
...
- ⚠️ Verify color accessibility (WCAG compliance)
- ⚠️ Check color blindness compatibility
- ⚠️ Ensure cultural appropriateness
...
- ⚠️ Validate data schema compliance
- ⚠️ Check for realistic value ranges
- ⚠️ Verify geographic coordinates
...
- ⚠️ Don't provide emergency response info
- ⚠️ Don't make policy decisions
- ⚠️ Always cite data sources
- ⚠️ Include disclaimers for predictions
- ⚠️ Provide human contact option
